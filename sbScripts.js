...
function checkCollision(object1, object2) {
	...
	if ((object1.x < object2.x + (object2.width / 1.5)) && (object1.x + (object1.width / 1.5) > object2.x) && 
		(object1.y < object2.y + (object2.height / 1.5)) && (object1.y + (object1.height / 1.5) > object2.y)) {
		//we're touching
		return true;
	}	
	else {
